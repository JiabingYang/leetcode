 ...
 */
public class No057InsertInterval {

    public static void main(String[] args) {
        List<Interval> intervals1 = new LinkedList<>(Arrays.asList(
                new Interval(1, 3),
                new Interval(6, 9)
        ));
        List<Interval> intervals2 = new LinkedList<>(Arrays.asList(
                new Interval(1, 2),
                new Interval(3, 5),
                new Interval(6, 7),
                new Interval(8, 10),
        ...
        List<Interval> intervals3 = new LinkedList<>(Arrays.asList(
                new Interval(1, 5)
        ));
        List<Interval> intervals4 = new LinkedList<>(Arrays.asList(
                new Interval(1, 5)
        ));
        List<Interval> intervals5 = new LinkedList<>(Arrays.asList(
                new Interval(3, 5),
                new Interval(12, 15)
        ));
        System.out.println(new No057InsertInterval().insert(intervals1, new Interval(2, 5)));
        System.out.println(new No057InsertInterval().insert(intervals2, new Interval(4, 9)));
        System.out.println(new No057InsertInterval().insert(intervals3, new Interval(6, 8)));
        System.out.println(new No057InsertInterval().insert(intervals4, new Interval(0, 0)));
        System.out.println(new No057InsertInterval().insert(intervals5, new Interval(6, 6)));
    }
