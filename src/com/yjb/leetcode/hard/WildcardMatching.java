...
public class WildcardMatching {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < testCases.length; i++) {
            ...
            results[i] = wildcardMatching.solution1V1(testCase[0], testCase[1]);
     ...
     * 89.01%
     */
    public boolean solution1V1(String s, String p) {
        if (s == null || p == null) {
            return false;
        }
     ...
     * 85.55%
     */
    public boolean solution1V2(String s, String p) {
        if (s == null || p == null) {
            return false;
        }
     ...
     * match[i][j]=false;
     */
    public boolean solution2Dp(String s, String p) {
        if (s == null || p == null) {
            return false;
        }
